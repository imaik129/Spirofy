  ...
  return (
    ...
    <div className="flex justify-center "> 
      <h3 className = "flex text-[2vw] mt-10 pd-20 mb-10 text-center text-black font-['Roboto']  font-light">
         Create Cool Graphs To Visualize Your Spotify Playlist!</h3> 
    </div>

    <div className="flex justify-center  "> 
      <p className = "flex text-[2vw]  mb-20 text-center text-sky-900 font-['Lato'] font-extralight"> 
    ...
    <div className="fixed top-3/4 left-1/2 -translate-y-1/2 -translate-x-1/2 bottom-10 h-20 "> 
      <button className = "min-h-[120px] sticky transform hover:scale-110  bg-white bg-opacity-70 hover:bg-green-400 mt-20 outline outline-2 outline-black w-200 transition duration-500 justify-between h-full  text-black p-4 rounded-xl bg-gradient-to-rfrom-black to-black hover:from-spotifyGreen hover:to-blue-500"
        onClick={() => signIn()}> <p className = "text-center font-thin px-20 text-[2vw]"> Start Exploring </p></button>
      </div> 
